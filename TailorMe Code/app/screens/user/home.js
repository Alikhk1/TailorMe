      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          <View style={styles.header}>
            ...
            <Text style={styles.headerSubtitle}>Perfect Fit, Effortlessly</Text>
          </View>
          ...
          >
            <Text style={styles.descriptionTitle}>Your Digital Tailor</Text>
            <Text style={styles.descriptionText}>
              Get precise body measurements using just your phone's camera. 
              Our AI technology ensures perfect fit recommendations for any clothing.
            </Text>
          </Animated.View>
          ...
          <View style={styles.buttonGroup}>
            ...
            >
              <TouchableOpacity
                ...
                onPress={() => handleNavigation('UserMeasurementScreen')}
                style={styles.card}
              >
                <Animated.View style={[styles.cardContent, { transform: [{ scale: buttonScale }] }]}>
                  ...
                  <View style={styles.cardText}>
                    ...
                    <Text style={styles.cardDescription}>AI-powered body scanning</Text>
                  </View>
              ...
              >
                <Animated.View style={[styles.cardContent, { transform: [{ scale: buttonScale }] }]}>
                  ...
                  <View style={styles.cardText}>
                    ...
                    <Text style={styles.cardDescription}>View your measurements</Text>
                  </View>
                  <Ionicons name="chevron-forward" size={24} color="rgba(255,255,255,0.7)" />
                </Animated.View>
              </TouchableOpacity>
            ...
            >
              ...
              >
                <Animated.View style={[styles.cardContent, { transform: [{ scale: buttonScale }] }]}>
                  ...
                  <View style={styles.cardText}>
                    <Text style={styles.cardTitle}>Find Tailors</Text>
                    <Text style={styles.cardDescription}>Near your location</Text>
                  </View>
                  <Ionicons name="chevron-forward" size={24} color="rgba(255,255,255,0.7)" />
                </Animated.View>
              </TouchableOpacity>
